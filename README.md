...
Egg has goals:
* Egg should be a productive replacement for Bash when used interactively in a terminal
...
* Scripting in Egg should be a maintainable endeavor
...
found in many general-purpose programming languages

## Status
The status of Egg is that Egg is still being drafted.
There is no set standard for Egg, only a laundry list of ideas and an interpreter is under
